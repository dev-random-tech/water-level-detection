#List of classes for The net and LabPics dataset
...
class Reader: # Reader for Labpics dataset
    # (multi thread reader read  next batch in the background and give it when asked by loadbatch)
...
#Create reader for data set create list of all files
        ...
        iii=0
        if TrainingMode: self.StartLoadBatch() # Start loading batch is multithread and work in the background
        self.AnnData=False
